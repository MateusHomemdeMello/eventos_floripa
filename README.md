...
todos os parâmetros de `AppConfig`, inclusive os avançados. Credenciais não são
incluídas. Use `configuracoes.exemplo.json` como modelo; campos omitidos assumem
